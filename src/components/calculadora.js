        ...
        <div>
            <div id="calculator-container">
                ...
                <div className="container-button" id="main-calculator">
                    ...
                    <button value="sin(" onClick={clickButton}>sin</button>
                    <button value="cos(" onClick={clickButton}>cos</button>
                    <button value="tag(" onClick={clickButton}>tan</button>
                    ...
                    <button value="-" onClick={clickButton} className="arithmetic">-</button>
                    <button onClick={clickReset} className="reset">AC</button>
                    ...
                    <button value="+" onClick={clickButton} className="arithmetic">+</button>
                    <button onClick={recuperateNumber}>MR</button>
                </div>

            </div>
            <span className='tag'>Done by David Molina
            </span>
            <a className='tag' href='https://github.com/molinaangeldavid'>
